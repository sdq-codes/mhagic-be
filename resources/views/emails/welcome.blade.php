...
<head>
    ...
    <title>Welcome to ALAJEHUB, {{ $user->name }}!</title>
    <!--
...
<body>
<span class="preheader">Thanks for registering with  AlajeHub {{ config('app.name') }}. We’ve pulled together some
                        ...
                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <p>
                                        {{ config('app.name') }}  is a platform that allows you buy and sell gift
                                        ...
                                        <tr>
                                            <td class="attributes_content">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="attributes_item"><strong>Login Page:</strong> {{ $loginLink }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="attributes_item"><strong>Email:</strong> {{ $user->email }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
